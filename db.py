    ...
    def create_if_needed(self):
        ...
        create_hand_statement = '''
            CREATE TABLE IF NOT EXISTS hand (
                ...
                villain_0_delta INTEGER NOT NULL,
                villain_1_delta INTEGER,
                villain_2_delta INTEGER,
                villain_3_delta INTEGER,
                villain_4_delta INTEGER,
                villain_5_delta INTEGER,
                villain_6_delta INTEGER,
                villain_7_delta INTEGER,
                villain_8_delta INTEGER,
